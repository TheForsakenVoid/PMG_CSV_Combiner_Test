...
FILES = {
    'clothing_test.csv': ('Blouses', 'Shirts', 'Tanks', 'Cardigans', 'Pants', 'Capris', '"Gingham" Shorts',),
    'accessories_test.csv': ('Watches', 'Wallets', 'Purses', 'Satchels',),
    'household_cleaners_test.csv': ('Kitchen Cleaner', 'Bathroom Cleaner',),
}
